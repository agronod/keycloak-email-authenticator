...
public class KeycloakEmailAuthenticator implements Authenticator {
        ...
        if (context.getUser().getEmail() != null) {
            ...
            if (context.getAuthenticationSession()
                    ...
                    && isTimestampValid(
                            ...
                            Integer.parseInt(
                                    configLoader.getInstance().getProperty("CODE.VALIDINMIN"), 10),
                            Integer.parseInt(configLoader.getInstance()
                                    .getProperty("CODE.ACTIVATIONDELAYINSEC"), 10))) {
    ...
    private void storeAndSendCode(AuthenticationFlowContext context) {
        ...
        System.out.println(context.getAuthenticationSession()
        ...
        if (sendCode(context.getUser().getEmail(), code, context.getAuthenticatorConfig())) {
            ...
            Response challenge = context.form().setError("E-post kund inte skickas.")
                    .createForm("mfa-validation.ftl");
    ...
    protected CODE_STATUS validateCode(AuthenticationFlowContext context) {
        ...
        if (enteredCode != null && context.getAuthenticationSession()
            ...
            if (isValid(enteredCode,
                    ...
                    Integer.parseInt(
                            configLoader.getInstance().getProperty("CODE.ACTIVATIONDELAYINSEC"),
    ...
    public boolean sendCode(String email, String code, AuthenticatorConfigModel config) {
        try {
            String apiUrl =
                    configLoader.getInstance().getProperty(EmailAuthenticatorContstants.API_URL);
            ...
            System.out
                    .println("Exception when calling TransactionalEmailsApi#sendTransacEmail" + e);
            return false;
        }
    ...
    private static String getJsonstring(String email, String verificationCode) {
        ...
        try {
            String jsonStr =
                    mapper.writerWithDefaultPrettyPrinter().writeValueAsString(templateJson);
            return jsonStr;
